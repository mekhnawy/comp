...
document.addEventListener('DOMContentLoaded', () => {
    ...
    switchView('list'); // Initialize with list view
});
...
function switchView(view) {
    ...
    if (productCards.length > 0) {
        ...
        const products = Array.from(productCards).map(card => {
            return {
                name: card.querySelector('.product-title').textContent.replace(/<[^>]*>/g, ''), // Remove HTML tags
                ...
                siteName: card.querySelector('.retailer-badge').textContent,
        ...
        if (currentView === 'grid') {
            ...
            <div class="product-card">
                <div class="product-image-container">
                    ...
                    <span class="retailer-badge">${retailerName}</span>
                ...
                <div class="product-details">
                    ...
                    <div class="product-actions">
                        <a href="${productLink}" target="_blank" class="btn btn-primary">
                            <i class="fas fa-shopping-cart"></i> Buy Now on  ${retailerName}
                        </a>
